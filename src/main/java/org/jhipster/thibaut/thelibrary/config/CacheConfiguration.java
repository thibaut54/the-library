...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("TheLibrary");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("TheLibrary");
        ...
        config.getMapConfigs().put("org.jhipster.thibaut.thelibrary.domain.*", initializeDomainMapConfig(jHipsterProperties));
